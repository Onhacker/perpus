                ...
                <div class="modal-body">
                    <form id="form_app" method="post"  enctype="multipart/form-data" >
                        ...
                        <div class="form-group mb-3">
                            <label class="text-primary">Jenis Penyakit</label>
                            <input class='form-control' name="nama_penyakit" type="text" id="nama_penyakit" autocomplete="off">
                        </div>
                        <div class="form-group mb-3">
                            <label class="text-primary">Urutan</label>
                            <input class='form-control' name="urutan" type="text" id="urutan" autocomplete="off">
                        </div>
                       <div class="form-group mb-3">
                            <label for="inputPassword4" class="col-form-label">Peruntukan</label>
                            <select name="bentuk" id="bentuk" class="form-control">
                                <option value="x">== Pilih Bentuk Lembaga ==</option>
                                <option value="1">RS dan PKM</option>
                                <option value="2">Hanya RS</option>
                            </select>
                        </div>
                </div>
