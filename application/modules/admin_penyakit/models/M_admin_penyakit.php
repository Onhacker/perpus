...
class M_admin_penyakit extends CI_Model {
	var $table2 = "users";
	var $table = 'master_penyakit';
	var $field2 = "username";
	var $column_order = array('','','nama_penyakit','bentuk','urutan');
	...
	private function get_data_query(){
		...
		if ($this->session->userdata("admin_level") == "admin") {
			$column_search = array('nama_penyakit','urutan'); 
		} else {
			$column_search = array('nama_penyakit'); 
		}
