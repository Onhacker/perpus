...
<body>
	<p align="center" class="judul"><strong>REKAPITULASI HASIL CAKUPAN BULAN IMUNISASI ANAK SEKOLAH ( BIAS )<br> DINAS KESEHATAN KABUPATEN <?php echo $this->om->web_me()->kabupaten ?> TAHUN <?php echo $admin_bias ?></strong></p>
	...
	<table id="basic-datatable" class="tabel" width="100%">
		<thead class="thead-light">
			<tr>
				...
				<th rowspan="4" width="11%" ><br><br>PUSKESMAS</th>
			...
			<tr>
				...
				<td width="11%"><?php echo ucwords(strtolower($row->nama_pkm)) ?></td>
