	...
	<table id="basic-datatable" class="tabel" width="100%">
		<thead class="thead-light">
			<tr>
				...
				<th rowspan="4" width="11%" ><br><br>SEKOLAH</th>
			...
			<tr>
				...
				<?php $this->db->where("id_sekolah",$row->id_sekolah);
						$s = $this->db->get("master_sekolah")->row() ?>
				<td width="11%"><?php echo (($s->sekolah)) ?></td>
				...
				<td align="center" width="2.5%" style="font-size: 9px"><?php echo numb((($row->imun_kelas_1_l_dt+$row->imun_kelas_1_p_dt)/($row->absen_kelas_1_p+$row->absen_kelas_1_l)) * 100) ?></td>
				...
				<td align="center" width="2.5%" style="font-size: 9px"><?php echo numb((($row->imun_kelas_1_p_cpk+$row->imun_kelas_1_l_cpk)/($row->absen_kelas_1_p+$row->absen_kelas_1_l)) * 100) ?></td>
				...
				<td align="center" width="2.5%" style="font-size: 9px"><?php echo numb((($row->imun_kelas_2_l+$row->imun_kelas_2_p)/($row->absen_kelas_2_p+$row->absen_kelas_2_l)) * 100) ?></td>
				...
				<td align="center" width="2.5%" style="font-size: 9px"><?php echo numb((($row->imun_kelas_5_l+$row->imun_kelas_5_p)/($row->absen_kelas_5_p+$row->absen_kelas_5_l)) * 100) ?></td>
				<td align="center" width="2.5%"><?php echo ve($row->vaksin_dt) ?></td>
				<td align="center" width="2.5%" style="font-size: 9px"><?php echo numb($row->vaksin_dt/($row->imun_kelas_1_l_dt+$row->imun_kelas_1_p_dt) * 100) ?></td>
				<td align="center" width="2.5%"><?php echo ve($row->vaksin_cpk) ?></td>
				<td align="center" width="2.5%" style="font-size: 9px"><?php echo numb($row->vaksin_cpk/($row->imun_kelas_1_p_cpk+$row->imun_kelas_1_l_cpk) * 100) ?></td>
				<td align="center" width="2.5%"><?php echo ve($row->vaksin_td) ?></td>
				<td align="center" width="2.5%" style="font-size: 9px"><?php echo numb($row->vaksin_td/($row->imun_kelas_2_l+$row->imun_kelas_2_p+$row->imun_kelas_5_l+$row->imun_kelas_5_p) * 100) ?></td>
		...
		<?php endforeach; ?>
			...
			<tr>
				...
				<td align="center" width="2.5%" style="font-size: 9px"><?php echo numb((($jum->imun_kelas_1_l_dt+$jum->imun_kelas_1_p_dt)/($jum->absen_kelas_1_p+$jum->absen_kelas_1_l)) * 100) ?></td>
				...
				<td align="center" width="2.5%" style="font-size: 9px"><?php echo numb((($jum->imun_kelas_1_p_cpk+$jum->imun_kelas_1_l_cpk)/($jum->absen_kelas_1_p+$jum->absen_kelas_1_l)) * 100) ?></td>
				...
				<td align="center" width="2.5%" style="font-size: 9px"><?php echo numb((($jum->imun_kelas_2_l+$jum->imun_kelas_2_p)/($jum->absen_kelas_2_p+$jum->absen_kelas_2_l)) * 100) ?></td>
				...
				<td align="center" width="2.5%" style="font-size: 9px"><?php echo numb((($jum->imun_kelas_5_l+$jum->imun_kelas_5_p)/($jum->absen_kelas_5_p+$jum->absen_kelas_5_l)) * 100) ?></td>
				<td align="center" width="2.5%"><?php echo ve($jum->vaksin_dt) ?></td>
				<td align="center" width="2.5%" style="font-size: 9px"><?php echo numb($jum->vaksin_dt/($jum->imun_kelas_1_l_dt+$jum->imun_kelas_1_p_dt) * 100) ?></td>
				<td align="center" width="2.5%"><?php echo ve($jum->vaksin_cpk) ?></td>
				<td align="center" width="2.5%" style="font-size: 9px"><?php echo numb($jum->vaksin_cpk/($jum->imun_kelas_1_p_cpk+$jum->imun_kelas_1_l_cpk) * 100) ?></td>
				<td align="center" width="2.5%"><?php echo ve($jum->vaksin_td) ?></td>
				<td align="center" width="2.5%" style="font-size: 9px"><?php echo numb($jum->vaksin_td/($jum->imun_kelas_2_l+$jum->imun_kelas_2_p+$jum->imun_kelas_5_l+$jum->imun_kelas_5_p) * 100) ?></td>
