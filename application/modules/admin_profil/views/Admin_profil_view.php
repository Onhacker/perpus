            ...
            <div class="card-box">
                ...
                <div class="tab-content">
                    <div class="tab-pane show active" id="settings" >
                        ...
                        <h5 class="mb-3 text-uppercase bg-light p-2"><i class="mdi mdi-account-circle mr-1"></i> Identitas</h5>
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <input class='form-control' name="nim" type="number" value="<?php echo (isset($record->nim))?$record->nim:"";  ?>" id="nim" autocomplete="off">
                            </div> 
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input class='form-control' name="alamat" type="text" value="<?php echo (isset($record->alamat))?$record->alamat:"";  ?>" id="alamat" autocomplete="off">
