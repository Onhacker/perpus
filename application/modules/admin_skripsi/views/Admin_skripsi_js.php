        ...
        if(list_id.length == 1) { 
            ...
            $.ajax({
                ...
                success: function(data) {
                    Swal.close();
                    $("#edit_text").text("Ganti File : ");
                    $('#id_skripsi').val(data.id_skripsi);
                    $('#judul').val(data.judul);
                    $('#pengarang').val(data.judul);
                    $('#tahun').val(data.tahun);
                    $('#tgl_diterima').val(data.tgl_diterima);

                    $('#nama_file').html('<a href="javascript:void(0)">'+data.file+'</a>')
                    if(data.file == ""){
                        $("#pre").hide();
                        $("#hapus_gambar").hide();
                        $("#text_upload").hide();
