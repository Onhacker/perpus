        ...
        <div class="col-lg-4 col-xl-4">
            <div class="card-box text-center">
                ...
                <div class="text-left mt-3">
                    ...
                    <p class="text-muted mb-2 font-13"><strong>Email :</strong> <span class="ml-2 "><?php echo $record->email ?></span></p>
                    ...
                    <p class="text-muted mb-1 font-13"><strong>Pengelola <?php echo $this->om->bentuk_admin($this->session->userdata("admin_pkm"),"p")." ".$this->om->identitas()->nama_pkm ?> :</strong> <span class="ml-2"><?php echo $this->om->user()->nama_lengkap ?></span></p>
                </div>     
            </div> 
        </div>
