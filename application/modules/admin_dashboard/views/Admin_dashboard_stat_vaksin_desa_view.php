                        ...
                        <?php if ($this->session->userdata("admin_level") == "admin") {?>
                            ...
                            <div class="col-md-<?php echo $md ?>">
                                <div class="form-group">
                                    ...
                                    echo form_dropdown("id_pkm",$this->ma->arr_pkm(),$id_pkm,'id="id_pkm" class="form-control"') 
                                    ?>
                                </div>
                            </div>
                        <?php } ?>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        <?php } ?>
        $('.spinner-grow').hide(); 
        $('#id_pkm,#jenis_vaksin,#tahun,#bulan_awal').select2();

    });
    function reset(){
         $('#jenis_vaksin,#tahun,#bulan_awal,#id_pkm').val('x').trigger('change');
         <?php if ($this->session->userdata("admin_level") != "admin") {?>
            load_stat_vaksin();      
        <?php } ?>
    }
    function load_stat_vaksin() {
        ...
        <?php if ($this->session->userdata("admin_level") == "admin") {?> 
            ...
            if (tahun =="" || id_pkm == "x" ) {
                ...
                $.ajax({
                    <?php if ($this->session->userdata("admin_level") == "admin") {?> 
                       url :'<?php echo site_url(strtolower($controller)."/load_stat_vaksin_desa"); ?>/'+jenis_vaksin+'/'+tahun+'/'+bulan_awal+'/'+id_pkm,
                   <?php } else {?>
                       url :'<?php echo site_url(strtolower($controller)."/load_stat_vaksin_desa"); ?>/'+jenis_vaksin+'/'+tahun+'/'+bulan_awal,
                   <?php } ?>
