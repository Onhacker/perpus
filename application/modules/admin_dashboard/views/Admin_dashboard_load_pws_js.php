<script type="text/javascript">
    ...
    Highcharts.chart('tampil_stat', {
        ...
        title: {
            text: 'Pemantauan Wilayah Setempat (PWS) <?php echo $pkm.". ".$vaksin ?>',
        },
        ...
        series: [
        {
          ...
          [<?php  
            foreach ($desa2->result() as $v) :
                ...
                $bysi = 100/$byj;
                if ($jenis_vaksin == "9999") {
                    $this->db->where(array("id_pkm" => $id_pkm, "id_desa" => $v->id_desa)); 
...
<script type="text/javascript">
    Highcharts.chart('tampil_bulan', {
        ...
        title: {
            ...
            text: '% <?php echo $waktu_awal ?><br><?php echo $pkm." ".$vaksin ?>',
...
<script type="text/javascript">
    ...
    Highcharts.chart('tampil_trend', {
        ...
        title: {
            ...
            text: 'Trend <?php echo $waktu_awal ?><br><?php echo $pkm." ".$vaksin ?>',
        },
