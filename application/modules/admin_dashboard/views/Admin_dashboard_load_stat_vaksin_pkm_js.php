<script type="text/javascript">
    ...
    Highcharts.chart('tampil_stat', {
        ...
        subtitle: {
            ...
            ?>
            text: 'Data Berdasarkan Semua PKM <?php echo ucwords(strtolower($this->om->web_me()->kabupaten)).". ".$nama_penyakit.". ".$thn.". ".$bln ?>'
        },
        xAxis: {
         categories: [<?php  
            foreach ($pkm->result() as $row) : 
                echo "'".(($row->nama_pkm))."',";
            endforeach;
            ?>]
        },
