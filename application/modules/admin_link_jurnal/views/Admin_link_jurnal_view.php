            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="form_app" method="post"  enctype="multipart/form-data" >
                        <input type="hidden" name="id_link_jurnal" id="id_link_jurnal">
                        <div class="form-group mb-3">
                            <label class="text-primary">Nama Situs</label>
                            <input class='form-control' name="nama_jurnal" type="text" id="nama_jurnal" autocomplete="off">
                        </div>
                         <div class="form-group mb-3">
