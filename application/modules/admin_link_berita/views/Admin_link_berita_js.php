    ...
    $(document).ready(function(){
        ...
        table = $('#datable_1').DataTable({
            ...
            columns: [
                ...
                {"data": "id_link_berita","orderable": false},
                {"data": "nama_berita"},
                {"data": "link"}, 
        ...
        if(list_id.length == 1) { 
            ...
            $.ajax({
                ...
                success: function(data) {
                    Swal.close();
                    $('#id_link_berita').val(data.id_link_berita);
                    $('#nama_berita').val(data.nama_berita);

                    $('#link').val(data.link);
                    $('#full-width-modal').modal('show'); 
                    $('.mymodal-title').html('Edit Data <code>'+ data.nama_berita+'</code>'); 
                },
