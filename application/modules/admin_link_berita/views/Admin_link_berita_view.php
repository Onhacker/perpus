            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="form_app" method="post"  enctype="multipart/form-data" >
                        <input type="hidden" name="id_link_berita" id="id_link_berita">
                        <div class="form-group mb-3">
                            <label class="text-primary">Nama Berita</label>
                            <input class='form-control' name="nama_berita" type="text" id="nama_berita" autocomplete="off">
                        </div>
                         <div class="form-group mb-3">
                            <label class="text-primary">Link</label>
                            <input class='form-control' name="link" type="url" id="link" autocomplete="off">
                            <small>Masukkan diawali dengan <code>https:// atau http://</code></small>
                        </div>
