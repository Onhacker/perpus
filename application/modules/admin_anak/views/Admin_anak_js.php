<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $('#tgl_lahir').datepicker('setEndDate', endDate);//1st set  end date
    ...
    function reset_select(){
       $('#id_agama,#id_desa,#id_pekerjaan_ayah,#id_pekerjaan_ibu,#id_desa_cari,#id_pkm').val('').trigger('change');
        ...
        if(list_id.length == 1) { 
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#golda').val(data.golda);
                    $('#id_agama').val(data.id_agama).trigger('change');
                    ...
                    $('#id_pekerjaan_ibu').val(data.id_pekerjaan_ibu).trigger('change');
                    $('#id_pekerjaan_ayah').val(data.id_pekerjaan_ayah).trigger('change');
                    $('#full-width-modal').modal('show'); 
