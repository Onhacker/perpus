<script type="text/javascript">
    ...
    $(document).ready(function(){
        $('#id_desa_cari,#tahun_cari,#id_pkm,#id_desa').select2();
        $('#id_desa').select2({
        ...
        table = $('#datable_1').DataTable({
            ...
            columns: [
                ...
                {"data": "id_sekolah","orderable": false},
                {"data": "sekolah"}, 
                {"data": "desa"}, 
                {"data": "kecamatan"},
    ...
    function reset_select(){
       $('#sekolah,#id_desa_cari,#id_pkm,#id_desa').val('').trigger('change');
    }
        ...
        if(list_id.length == 1) { 
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#full-width-modal').modal('show'); 
                    $('.mymodal-title').html('Edit Data <code>'+ data.sekolah+'</code>'); 
                },
