...
<head>
    ...
    <body class="authentication-bg">
                ...
                <div class="row justify-content-center">
                    <div class="col-12">
                        ...
                        <div class="text-center">
                            <h2>
                                <a href="index.html">
                                    <img src="<?php echo base_url("assets/admin") ?>/images/logo-dark.png" alt="main-logo" height="24" />
                                </a>
                            </h2>
                            ...
                            <div class="row mt-5 justify-content-center">
                                <div class="col-md-8">
                                    <div data-countdown="2020/05/17" class="counter-number"></div>
                                </div> <!-- end col-->
                            </div> <!-- end row-->
                        </div> <!-- end /.text-center-->
        ...
        <footer class="footer footer-alt">
            2015 - 2019 &copy; UBold theme by <a href="#" class="text-body">Coderthemes</a> 
        </footer>
        ...
        <!-- Plugins js-->
        <script src="<?php echo base_url("assets/admin") ?>/libs/jquery-countdown/jquery.countdown.min.js"></script>

        <!-- Countdown js -->
        <script src="<?php echo base_url("assets/admin") ?>/js/pages/coming-soon.init.js"></script>
