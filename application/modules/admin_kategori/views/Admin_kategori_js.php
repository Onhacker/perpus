            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if(data.gambar_utama == ""){
                        ...
                        $('#previewImage').attr('src', '<?php echo base_url("upload/gambar/") ?>' + data.gambar_utama);
                        $("#hapus_gambar").show();  
                        $("#text_upload").show();
                    }
                    $('#full-width-modal').modal('show'); 
                    $('.mymodal-title').html('Edit Data <code>'+ data.nama_kategori+'</code>'); 
                },
                error: function (jqXHR, textStatus, errorThrown) {
