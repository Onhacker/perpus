                    ...
                    <table id="datable_1" class="table table-striped table-bordered" style="width:100%">
                        <thead>
                            <tr>
                                ...
                                <th>Nama <?php echo $this->om->engine_nama_menu("Admin_kategori") ?></th>
                                <th width="5%">Jumlah Artikel</th>
                                <th width="15%">Status/ Link/ Copy</th>
                ...
                <div class="modal-body">
                    <form id="form_app" method="post"  enctype="multipart/form-data" >
                        ...
                        <div class="form-group mb-3">
                            <label class="text-primary">Nama <?php echo $this->om->engine_nama_menu("Admin_kategori") ?></label>
