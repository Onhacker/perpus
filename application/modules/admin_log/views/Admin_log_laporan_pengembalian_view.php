                      ...
                      <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class='form-control' value="<?php echo tgl_view(date("Y-m-d")) ?>" data-date-autoclose="true"  type="text" id="range_awal"  autocomplete="off">
...
<script type="text/javascript">
    ...
    function cetak() {
        ...
        if (awal == ""  || akhir == "" ) {
            ...
            window.open("<?php echo site_url(strtolower($controller)."/laporan_pengembalian_pdf"); ?>/"+awal+'/'+akhir);
