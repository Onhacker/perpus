...
class M_admin_riwayat_ibu extends CI_Model {
	var $table = 'imunisasi_ibu';
	var $column_order = array('','no_kia','nama','tgl_lahir','id_desa','id_pkm','');
	var $column_search = array('nama'); 
	var $order = array('id_ibu' => 'DESC');
