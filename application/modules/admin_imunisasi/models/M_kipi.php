...
class M_kipi extends CI_Model {
	var $table = 'imunisasi_kipi';
	var $column_order = array('','','nama','jk','tgl_lahir','tgl_suntik','jenis_vaksin_1','jenis_vaksin_2','id_pkm');
	...
	function arr_tahun(){
		...
		$res = $this->db->get("imunisasi_kipi");
		$arr[""]  = "== Semua Tahun == ";
		foreach($res->result() as $row) :
