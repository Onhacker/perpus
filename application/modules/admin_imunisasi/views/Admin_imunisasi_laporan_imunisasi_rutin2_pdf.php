	...
	<table id="basic-datatable" class="tabel" width="100%">
		<thead>
			...
			<tr>
				...
				<?php
					// IPV (< 24 JAM) L
					$this->db->where(array("id_pkm" => $id_pkm, "id_desa" => $row->id_desa,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "121", "jk" => "L")); 
					$hbl = $this->db->get("imunisasi");
					// IPV (< 24 JAM) P
					$this->db->where(array("id_pkm" => $id_pkm, "id_desa" => $row->id_desa,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "121", "jk" => "P")); 
				...
				<?php
					// MR (1<7 HARI) L
					$this->db->where(array("id_pkm" => $id_pkm, "id_desa" => $row->id_desa,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "124", "jk" => "L")); 
					$hbl1 = $this->db->get("imunisasi");
					// MR (1<7 HARI) P
					$this->db->where(array("id_pkm" => $id_pkm, "id_desa" => $row->id_desa,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "124", "jk" => "P")); 
				...
				<?php
					...
					$this->db->where(array("id_pkm" => $id_pkm, "id_desa" => $row->id_desa,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "129", "jk" => "L")); 
					$polio1l = $this->db->get("imunisasi");
					// PENTAVALEN LANJUTAN P
					$this->db->where(array("id_pkm" => $id_pkm, "id_desa" => $row->id_desa,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "129", "jk" => "P")); 
				...
				<?php
					// CAMPAK LANJUTAN L
					$this->db->where(array("id_pkm" => $id_pkm, "id_desa" => $row->id_desa,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "120", "jk" => "L")); 
					$pentavaln1l = $this->db->get("imunisasi");
					// CAMPAK LANJUTAN P
					$this->db->where(array("id_pkm" => $id_pkm, "id_desa" => $row->id_desa,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "120", "jk" => "P")); 
				...
				<?php
					// MR LANJUTAN L
				$this->db->where(array("id_pkm" => $id_pkm, "id_desa" => $row->id_desa,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "138", "jk" => "L")); 
				$polio2l = $this->db->get("imunisasi");
					// MR LANJUTAN P
				$this->db->where(array("id_pkm" => $id_pkm, "id_desa" => $row->id_desa,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "138", "jk" => "P")); 
				...
				<?php
					...
					$this->db->where(array("id_pkm" => $id_pkm, "id_desa" => $row->id_desa,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "tt1")); 
					$tt1 = $this->db->get("imunisasi_ibu");

					$this->db->where(array("id_pkm" => $id_pkm, "id_desa" => $row->id_desa,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "tt2")); 
					$tt2 = $this->db->get("imunisasi_ibu");

					$this->db->where(array("id_pkm" => $id_pkm, "id_desa" => $row->id_desa,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "tt3")); 
					$tt3 = $this->db->get("imunisasi_ibu");

					$this->db->where(array("id_pkm" => $id_pkm, "id_desa" => $row->id_desa,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "tt3")); 
					$tt3 = $this->db->get("imunisasi_ibu");

					$this->db->where(array("id_pkm" => $id_pkm, "id_desa" => $row->id_desa,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "tt4")); 
					$tt4 = $this->db->get("imunisasi_ibu");
					$this->db->where(array("id_pkm" => $id_pkm, "id_desa" => $row->id_desa,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "tt5")); 
					$tt5 = $this->db->get("imunisasi_ibu");
					$this->db->where(array("id_pkm" => $id_pkm, "id_desa" => $row->id_desa,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "ttll")); 
				...
				<?php
					...
					$this->db->where(array("id_pkm" => $id_pkm, "id_desa" => $row->id_desa,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "ttw1")); 
					$ttw1 = $this->db->get("imunisasi_ibu");

					$this->db->where(array("id_pkm" => $id_pkm, "id_desa" => $row->id_desa,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "ttw2")); 
					$ttw2 = $this->db->get("imunisasi_ibu");

					$this->db->where(array("id_pkm" => $id_pkm, "id_desa" => $row->id_desa,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "ttw3")); 
					$ttw3 = $this->db->get("imunisasi_ibu");

					$this->db->where(array("id_pkm" => $id_pkm, "id_desa" => $row->id_desa,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "ttw3")); 
					$ttw3 = $this->db->get("imunisasi_ibu");

					$this->db->where(array("id_pkm" => $id_pkm, "id_desa" => $row->id_desa,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "ttw4")); 
					$ttw4 = $this->db->get("imunisasi_ibu");
					$this->db->where(array("id_pkm" => $id_pkm, "id_desa" => $row->id_desa,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "ttw5")); 
					$ttw5 = $this->db->get("imunisasi_ibu");
					$this->db->where(array("id_pkm" => $id_pkm, "id_desa" => $row->id_desa,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "ttwll")); 
		...
		<?php endforeach; ?>
			<tr>
				...
				<?php
					// IPV (< 24 JAM) L
					$this->db->where(array("id_pkm" => $id_pkm,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "121", "jk" => "L")); 
					$hbl = $this->db->get("imunisasi");
					// IPV (< 24 JAM) P
					$this->db->where(array("id_pkm" => $id_pkm,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "121", "jk" => "P")); 
					$hbp = $this->db->get("imunisasi");
				?>
				<td width="2.5%" align="center"><?php echo uang($hbl->num_rows()) ?></td>
				<td width="2.5%" align="center"><?php echo uang($hbp->num_rows()) ?></td>
				...
				<?php
					// MR (1<7 HARI) L
					$this->db->where(array("id_pkm" => $id_pkm,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "124", "jk" => "L")); 
					$hbl1 = $this->db->get("imunisasi");
					// MR (1<7 HARI) P
					$this->db->where(array("id_pkm" => $id_pkm,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "124", "jk" => "P")); 
					$hbp2 = $this->db->get("imunisasi");
				...
				<?php
					// PENTAVALEN LANJUTAN L
					$this->db->where(array("id_pkm" => $id_pkm,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "129", "jk" => "L")); 
					$polio1l = $this->db->get("imunisasi");
					// PENTAVALEN LANJUTAN P
					$this->db->where(array("id_pkm" => $id_pkm,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "129", "jk" => "P")); 
					$polio1p = $this->db->get("imunisasi");
				...
				<?php
					// CAMPAK LANJUTAN L
					$this->db->where(array("id_pkm" => $id_pkm,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "120", "jk" => "L")); 
					$pentavaln1l = $this->db->get("imunisasi");
					// CAMPAK LANJUTAN P
					$this->db->where(array("id_pkm" => $id_pkm,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "120", "jk" => "P")); 
					$pentabalen1p = $this->db->get("imunisasi");
				...
				<?php
					// MR LANJUTAN L
				$this->db->where(array("id_pkm" => $id_pkm,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "138", "jk" => "L")); 
				$polio2l = $this->db->get("imunisasi");
					// MR LANJUTAN P
				$this->db->where(array("id_pkm" => $id_pkm,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "138", "jk" => "P")); 
				$polio2p = $this->db->get("imunisasi");
				...
				<?php
					...
					$this->db->where(array("id_pkm" => $id_pkm,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "tt1")); 
					$tt1 = $this->db->get("imunisasi_ibu");

					$this->db->where(array("id_pkm" => $id_pkm,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "tt2")); 
					$tt2 = $this->db->get("imunisasi_ibu");

					$this->db->where(array("id_pkm" => $id_pkm,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "tt3")); 
					$tt3 = $this->db->get("imunisasi_ibu");

					$this->db->where(array("id_pkm" => $id_pkm,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "tt3")); 
					$tt3 = $this->db->get("imunisasi_ibu");

					$this->db->where(array("id_pkm" => $id_pkm,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "tt4")); 
					$tt4 = $this->db->get("imunisasi_ibu");
					$this->db->where(array("id_pkm" => $id_pkm,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "tt5")); 
					$tt5 = $this->db->get("imunisasi_ibu");
					$this->db->where(array("id_pkm" => $id_pkm,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "ttll")); 
					$ttll = $this->db->get("imunisasi_ibu");
				...
				<?php
					...
					$this->db->where(array("id_pkm" => $id_pkm,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "ttw1")); 
					$ttw1 = $this->db->get("imunisasi_ibu");

					$this->db->where(array("id_pkm" => $id_pkm,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "ttw2")); 
					$ttw2 = $this->db->get("imunisasi_ibu");

					$this->db->where(array("id_pkm" => $id_pkm,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "ttw3")); 
					$ttw3 = $this->db->get("imunisasi_ibu");

					$this->db->where(array("id_pkm" => $id_pkm,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "ttw3")); 
					$ttw3 = $this->db->get("imunisasi_ibu");

					$this->db->where(array("id_pkm" => $id_pkm,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "ttw4")); 
					$ttw4 = $this->db->get("imunisasi_ibu");
					$this->db->where(array("id_pkm" => $id_pkm,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "ttw5")); 
					$ttw5 = $this->db->get("imunisasi_ibu");
					$this->db->where(array("id_pkm" => $id_pkm,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "ttwll")); 
					$ttwll = $this->db->get("imunisasi_ibu");
