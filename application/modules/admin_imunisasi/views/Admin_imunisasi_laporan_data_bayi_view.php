...
<script type="text/javascript">
    ...
    function cetak() {
        ...
        window.open("<?php echo site_url(strtolower($controller)."/laporan_bayi_pdf"); ?>/"+tahun+'/'+bulan+'/'+id_pkm+'/'+id_desa+'/'+jk+'/'+jenis_vaksin);
    ...
    function cetak_excel() {
        ...
        window.open("<?php echo site_url("excelx/laporan_bayi_excel"); ?>/"+tahun+'/'+bulan+'/'+id_pkm+'/'+id_desa+'/'+jk+'/'+jenis_vaksin);
