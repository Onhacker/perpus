...
<script type="text/javascript">
    ...
    function cetak() {
        ...
        window.open("<?php echo site_url(strtolower($controller)."/laporan_imunisasi_rutin_dinas_pdf"); ?>/"+tahun+'/'+bulan+'/'+ttd);
    ...
    function cetak_excel() {
        ...
        window.open("<?php echo site_url("excelx/laporan_imunisasi_rutin_dinas_excel"); ?>/"+tahun+'/'+bulan+'/'+ttd);
