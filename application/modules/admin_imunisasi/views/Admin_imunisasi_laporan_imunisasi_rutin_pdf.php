	...
	<table id="basic-datatable" class="tabel" width="100%">
		<thead>
			...
			<tr>
				...
				<?php
					...
					$this->db->where(array("id_pkm" => $id_pkm, "id_desa" => $row->id_desa,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "154", "jk" => "L")); 
					$hbl = $this->db->get("imunisasi");
					// HB0 (< 24 JAM) P
					$this->db->where(array("id_pkm" => $id_pkm, "id_desa" => $row->id_desa,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "154", "jk" => "P")); 
				...
				<?php
					// HB0 (1<7 HARI) L
					$this->db->where(array("id_pkm" => $id_pkm, "id_desa" => $row->id_desa,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "137", "jk" => "L")); 
					$hbl1 = $this->db->get("imunisasi");
					// HB0 (1<7 HARI) P
					$this->db->where(array("id_pkm" => $id_pkm, "id_desa" => $row->id_desa,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "137", "jk" => "P")); 
				...
				<?php
					// BCG L
					$this->db->where(array("id_pkm" => $id_pkm, "id_desa" => $row->id_desa,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "117", "jk" => "L")); 
					$bcgl = $this->db->get("imunisasi");
					// BCG P
					$this->db->where(array("id_pkm" => $id_pkm, "id_desa" => $row->id_desa,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "117", "jk" => "P")); 
				...
				<?php
					// POLIO (1) L
					$this->db->where(array("id_pkm" => $id_pkm, "id_desa" => $row->id_desa,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "127", "jk" => "L")); 
					$polio1l = $this->db->get("imunisasi");
					// POLIO (1) P
					$this->db->where(array("id_pkm" => $id_pkm, "id_desa" => $row->id_desa,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "127", "jk" => "P")); 
				...
				<?php
					// PENTAVALEN 1 (1) L
					$this->db->where(array("id_pkm" => $id_pkm, "id_desa" => $row->id_desa,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "119", "jk" => "L")); 
					$pentavaln1l = $this->db->get("imunisasi");
					// PENTAVALEN 1 (1) P
					$this->db->where(array("id_pkm" => $id_pkm, "id_desa" => $row->id_desa,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "119", "jk" => "P")); 
				...
				<?php
					// POLIO (2) L
				$this->db->where(array("id_pkm" => $id_pkm, "id_desa" => $row->id_desa,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "126", "jk" => "L")); 
				$polio2l = $this->db->get("imunisasi");
					// POLIO (2) P
				$this->db->where(array("id_pkm" => $id_pkm, "id_desa" => $row->id_desa,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "126", "jk" => "P")); 
				...
				<?php
					// PENTAVALEN 2 L
					$this->db->where(array("id_pkm" => $id_pkm, "id_desa" => $row->id_desa,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "128", "jk" => "L")); 
					$pentavaln2l = $this->db->get("imunisasi");
					// PENTAVALEN 2 P
					$this->db->where(array("id_pkm" => $id_pkm, "id_desa" => $row->id_desa,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "128", "jk" => "P")); 
				...
				<?php
					// POLIO 3 L
					$this->db->where(array("id_pkm" => $id_pkm, "id_desa" => $row->id_desa,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "122", "jk" => "L")); 
					$polio3l = $this->db->get("imunisasi");
					// POLIO 3 P
					$this->db->where(array("id_pkm" => $id_pkm, "id_desa" => $row->id_desa,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "122", "jk" => "P")); 
				...
				<?php
					// PENTAVALEN 3 L
					$this->db->where(array("id_pkm" => $id_pkm, "id_desa" => $row->id_desa,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "125", "jk" => "L")); 
					$pentavaln3l = $this->db->get("imunisasi");
					// PENTAVALEN 3 P
					$this->db->where(array("id_pkm" => $id_pkm, "id_desa" => $row->id_desa,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "125", "jk" => "P")); 
				...
				<?php
					// POLIO 3 L
					$this->db->where(array("id_pkm" => $id_pkm, "id_desa" => $row->id_desa,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "130", "jk" => "L")); 
					$polio4l = $this->db->get("imunisasi");
					// POLIO 3 P
					$this->db->where(array("id_pkm" => $id_pkm, "id_desa" => $row->id_desa,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "130", "jk" => "P")); 
		...
		<?php endforeach; ?>
			<tr>
				...
				<?php
					// HB0 (< 24 JAM) L
					$this->db->where(array("id_pkm" => $id_pkm,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "154", "jk" => "L")); 
					$hbl = $this->db->get("imunisasi");
					// HB0 (< 24 JAM) P
					$this->db->where(array("id_pkm" => $id_pkm,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "154", "jk" => "P")); 
					$hbp = $this->db->get("imunisasi");
				?>
				<td width="2.5%" align="center"><?php echo uang($hbl->num_rows()) ?></td>
				<td width="2.5%" align="center"><?php echo uang($hbp->num_rows()) ?></td>
				...
				<?php
					// HB0 (1<7 HARI) L
					$this->db->where(array("id_pkm" => $id_pkm,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "137", "jk" => "L")); 
					$hbl1 = $this->db->get("imunisasi");
					// HB0 (1<7 HARI) P
					$this->db->where(array("id_pkm" => $id_pkm,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "137", "jk" => "P")); 
					$hbp2 = $this->db->get("imunisasi");
				...
				<?php
					// BCG L
					$this->db->where(array("id_pkm" => $id_pkm,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "117", "jk" => "L")); 
					$bcgl = $this->db->get("imunisasi");
					// BCG P
					$this->db->where(array("id_pkm" => $id_pkm,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "117", "jk" => "P")); 
					$bcgp = $this->db->get("imunisasi");
				...
				<?php
					// POLIO (1) L
					$this->db->where(array("id_pkm" => $id_pkm,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "127", "jk" => "L")); 
					$polio1l = $this->db->get("imunisasi");
					// POLIO (1) P
					$this->db->where(array("id_pkm" => $id_pkm,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "127", "jk" => "P")); 
					$polio1p = $this->db->get("imunisasi");
				...
				<?php
					// PENTAVALEN 1 (1) L
					$this->db->where(array("id_pkm" => $id_pkm,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "119", "jk" => "L")); 
					$pentavaln1l = $this->db->get("imunisasi");
					// PENTAVALEN 1 (1) P
					$this->db->where(array("id_pkm" => $id_pkm,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "119", "jk" => "P")); 
					$pentabalen1p = $this->db->get("imunisasi");
				...
				<?php
					// POLIO (2) L
				$this->db->where(array("id_pkm" => $id_pkm,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "126", "jk" => "L")); 
				$polio2l = $this->db->get("imunisasi");
					// POLIO (2) P
				$this->db->where(array("id_pkm" => $id_pkm,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "126", "jk" => "P")); 
				$polio2p = $this->db->get("imunisasi");
				...
				<?php
					// PENTAVALEN 2 L
					$this->db->where(array("id_pkm" => $id_pkm,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "128", "jk" => "L")); 
					$pentavaln2l = $this->db->get("imunisasi");
					// PENTAVALEN 2 P
					$this->db->where(array("id_pkm" => $id_pkm,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "128", "jk" => "P")); 
					$pentabalen2p = $this->db->get("imunisasi");
				...
				<?php
					// POLIO 3 L
					$this->db->where(array("id_pkm" => $id_pkm,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "122", "jk" => "L")); 
					$polio3l = $this->db->get("imunisasi");
					// POLIO 3 P
					$this->db->where(array("id_pkm" => $id_pkm,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "122", "jk" => "P")); 
					$polio3p = $this->db->get("imunisasi");
				...
				<?php
					// PENTAVALEN 3 L
					$this->db->where(array("id_pkm" => $id_pkm,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "125", "jk" => "L")); 
					$pentavaln3l = $this->db->get("imunisasi");
					// PENTAVALEN 3 P
					$this->db->where(array("id_pkm" => $id_pkm,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "125", "jk" => "P")); 
					$pentabalen3p = $this->db->get("imunisasi");
				...
				<?php
					// POLIO 3 L
					$this->db->where(array("id_pkm" => $id_pkm,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "130", "jk" => "L")); 
					$polio4l = $this->db->get("imunisasi");
					// POLIO 3 P
					$this->db->where(array("id_pkm" => $id_pkm,  "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jenis_vaksin" => "130", "jk" => "P")); 
					$polio4p = $this->db->get("imunisasi");
