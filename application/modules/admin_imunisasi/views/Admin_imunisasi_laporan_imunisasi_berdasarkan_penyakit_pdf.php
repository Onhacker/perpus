...
<body>
	...
	if ($id_pkm != "") {
		$jdl = "LAPORAN BERDASARKAN JENIS IMUNISASI ".strtoupper($this->om->bentuk_admin($id_pkm,"p")) ." ".strtoupper($this->om->identitas_general($id_pkm)->nama_pkm);
	...
	<table id="basic-datatable" class="tabel" width="100%">
		...
		<?php 
			...
			<tr>
				...
				<?php 
				$this->db->where(array("id_pkm" => $id_pkm, "jenis_vaksin" => $row->id_penyakit, "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jk" => "L")); 
				$l_i = $this->db->get("imunisasi");
				?>
				<td width="8.33%" align="center"><?php echo $l_i->num_rows() ?></td>
				<?php 
				$this->db->where(array("id_pkm" => $id_pkm, "jenis_vaksin" => $row->id_penyakit, "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan, "jk" => "P")); 
				...
				$this->db->where(array("id_pkm" => $id_pkm, "jenis_vaksin" => $row->id_penyakit, "year(tgl_suntik)" => $tahun, "jk" => "L")); 
				$ld_i = $this->db->get("imunisasi");
				?>
				<td width="8.33%" align="center"><?php echo $ld_i->num_rows() ?></td>
				<?php 
				$this->db->where("bulan between '1' and ".$bulan." "); 
				$this->db->where(array("id_pkm" => $id_pkm, "jenis_vaksin" => $row->id_penyakit, "year(tgl_suntik)" => $tahun, "jk" => "P")); 
		...
		<tr>
			...
			<tr>
				...
				<td width="45%">Td 1 </td>
				<?php 
					$this->db->where(array("id_pkm" => $id_pkm, "jenis_vaksin" => "tt1", "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan)); 
					$a = $this->db->get("imunisasi_ibu");
				?>
				<td width="8.33%" align="center"><?php echo $a->num_rows() ?></td>
				<?php 
					$this->db->where(array("id_pkm" => $id_pkm, "jenis_vaksin" => "ttw1", "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan)); 
				...
				<?php 
					$this->db->where("bulan between '1' and ".$bulan." "); 
					$this->db->where(array("id_pkm" => $id_pkm, "jenis_vaksin" => "tt1", "year(tgl_suntik)" => $tahun)); 
					$c = $this->db->get("imunisasi_ibu");
				?>
				<td width="8.33%" align="center"><?php echo $c->num_rows() ?></td>
				<?php 
					$this->db->where("bulan between '1' and ".$bulan." "); 
					$this->db->where(array("id_pkm" => $id_pkm, "jenis_vaksin" => "ttw1", "year(tgl_suntik)" => $tahun)); 
			...
			<tr>
				...
				<td width="45%">Td 2 </td>
				<?php 
					$this->db->where(array("id_pkm" => $id_pkm, "jenis_vaksin" => "tt2", "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan)); 
					$a = $this->db->get("imunisasi_ibu");
				?>
				<td width="8.33%" align="center"><?php echo $a->num_rows() ?></td>
				<?php 
					$this->db->where(array("id_pkm" => $id_pkm, "jenis_vaksin" => "ttw2", "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan)); 
					$b = $this->db->get("imunisasi_ibu");
				?>
				<td width="8.33%" align="center"><?php echo $b->num_rows() ?></td>
				<td width="8.33%" align="center"><?php echo $b->num_rows()+$a->num_rows() ?></td>
				...
				<?php 
					$this->db->where("bulan between '1' and ".$bulan." "); 
					$this->db->where(array("id_pkm" => $id_pkm, "jenis_vaksin" => "tt2", "year(tgl_suntik)" => $tahun)); 
					$c = $this->db->get("imunisasi_ibu");
				?>
				<td width="8.33%" align="center"><?php echo $c->num_rows() ?></td>
				<?php 
					$this->db->where("bulan between '1' and ".$bulan." "); 
					$this->db->where(array("id_pkm" => $id_pkm, "jenis_vaksin" => "ttw2", "year(tgl_suntik)" => $tahun)); 
					$d = $this->db->get("imunisasi_ibu");
				?>
				<td width="8.33%" align="center"><?php echo $d->num_rows() ?></td>
				<td width="8.33%" align="center"><?php echo $d->num_rows()+$c->num_rows() ?></td>
			...
			<tr>
				...
				<td width="45%">Td 3 </td>
				<?php 
					$this->db->where(array("id_pkm" => $id_pkm, "jenis_vaksin" => "tt3", "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan)); 
					$a = $this->db->get("imunisasi_ibu");
				?>
				<td width="8.33%" align="center"><?php echo $a->num_rows() ?></td>
				<?php 
					$this->db->where(array("id_pkm" => $id_pkm, "jenis_vaksin" => "ttw3", "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan)); 
					$b = $this->db->get("imunisasi_ibu");
				?>
				<td width="8.33%" align="center"><?php echo $b->num_rows() ?></td>
				<td width="8.33%" align="center"><?php echo $b->num_rows()+$a->num_rows() ?></td>
				...
				<?php 
					$this->db->where("bulan between '1' and ".$bulan." "); 
					$this->db->where(array("id_pkm" => $id_pkm, "jenis_vaksin" => "tt3", "year(tgl_suntik)" => $tahun)); 
					$c = $this->db->get("imunisasi_ibu");
				?>
				<td width="8.33%" align="center"><?php echo $c->num_rows() ?></td>
				<?php 
					$this->db->where("bulan between '1' and ".$bulan." "); 
					$this->db->where(array("id_pkm" => $id_pkm, "jenis_vaksin" => "ttw3", "year(tgl_suntik)" => $tahun)); 
					$d = $this->db->get("imunisasi_ibu");
				?>
				<td width="8.33%" align="center"><?php echo $d->num_rows() ?></td>
				<td width="8.33%" align="center"><?php echo $d->num_rows()+$c->num_rows() ?></td>
			...
			<tr>
				...
				<td width="45%">Td 4 </td>
				<?php 
					$this->db->where(array("id_pkm" => $id_pkm, "jenis_vaksin" => "tt4", "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan)); 
					$a = $this->db->get("imunisasi_ibu");
				?>
				<td width="8.33%" align="center"><?php echo $a->num_rows() ?></td>
				<?php 
					$this->db->where(array("id_pkm" => $id_pkm, "jenis_vaksin" => "ttw4", "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan)); 
					$b = $this->db->get("imunisasi_ibu");
				?>
				<td width="8.33%" align="center"><?php echo $b->num_rows() ?></td>
				<td width="8.33%" align="center"><?php echo $b->num_rows()+$a->num_rows() ?></td>
				...
				<?php 
					$this->db->where("bulan between '1' and ".$bulan." "); 
					$this->db->where(array("id_pkm" => $id_pkm, "jenis_vaksin" => "tt4", "year(tgl_suntik)" => $tahun)); 
					$c = $this->db->get("imunisasi_ibu");
				?>
				<td width="8.33%" align="center"><?php echo $c->num_rows() ?></td>
				<?php 
					$this->db->where("bulan between '1' and ".$bulan." "); 
					$this->db->where(array("id_pkm" => $id_pkm, "jenis_vaksin" => "ttw4", "year(tgl_suntik)" => $tahun)); 
					$d = $this->db->get("imunisasi_ibu");
				?>
				<td width="8.33%" align="center"><?php echo $d->num_rows() ?></td>
				<td width="8.33%" align="center"><?php echo $d->num_rows()+$c->num_rows() ?></td>
			...
			<tr>
				...
				<td width="45%">Td 5 </td>
				<?php 
					$this->db->where(array("id_pkm" => $id_pkm, "jenis_vaksin" => "tt5", "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan)); 
					$a = $this->db->get("imunisasi_ibu");
				?>
				<td width="8.33%" align="center"><?php echo $a->num_rows() ?></td>
				<?php 
					$this->db->where(array("id_pkm" => $id_pkm, "jenis_vaksin" => "ttw5", "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan)); 
					$b = $this->db->get("imunisasi_ibu");
				?>
				<td width="8.33%" align="center"><?php echo $b->num_rows() ?></td>
				<td width="8.33%" align="center"><?php echo $b->num_rows()+$a->num_rows() ?></td>
				...
				<?php 
					$this->db->where("bulan between '1' and ".$bulan." "); 
					$this->db->where(array("id_pkm" => $id_pkm, "jenis_vaksin" => "tt5", "year(tgl_suntik)" => $tahun)); 
					$c = $this->db->get("imunisasi_ibu");
				?>
				<td width="8.33%" align="center"><?php echo $c->num_rows() ?></td>
				<?php 
					$this->db->where("bulan between '1' and ".$bulan." "); 
					$this->db->where(array("id_pkm" => $id_pkm, "jenis_vaksin" => "ttw5", "year(tgl_suntik)" => $tahun)); 
					$d = $this->db->get("imunisasi_ibu");
				?>
				<td width="8.33%" align="center"><?php echo $d->num_rows() ?></td>
				<td width="8.33%" align="center"><?php echo $d->num_rows()+$c->num_rows() ?></td>
			...
			<tr>
				...
				<?php 
					$this->db->where(array("id_pkm" => $id_pkm, "jenis_vaksin" => "ttll", "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan)); 
					$a = $this->db->get("imunisasi_ibu");
				?>
				<td width="8.33%" align="center"><?php echo $a->num_rows() ?></td>
				<?php 
					$this->db->where(array("id_pkm" => $id_pkm, "jenis_vaksin" => "ttwll", "year(tgl_suntik)" => $tahun, "month(tgl_suntik)" => $bulan)); 
					$b = $this->db->get("imunisasi_ibu");
				?>
				<td width="8.33%" align="center"><?php echo $b->num_rows() ?></td>
				<td width="8.33%" align="center"><?php echo $b->num_rows()+$a->num_rows() ?></td>
				...
				<?php 
					$this->db->where("bulan between '1' and ".$bulan." "); 
					$this->db->where(array("id_pkm" => $id_pkm, "jenis_vaksin" => "ttll", "year(tgl_suntik)" => $tahun)); 
					$c = $this->db->get("imunisasi_ibu");
				?>
				<td width="8.33%" align="center"><?php echo $c->num_rows() ?></td>
				<?php 
					$this->db->where("bulan between '1' and ".$bulan." "); 
					$this->db->where(array("id_pkm" => $id_pkm, "jenis_vaksin" => "ttwll", "year(tgl_suntik)" => $tahun)); 
					$d = $this->db->get("imunisasi_ibu");
				?>
				<td width="8.33%" align="center"><?php echo $d->num_rows() ?></td>
				<td width="8.33%" align="center"><?php echo $d->num_rows()+$c->num_rows() ?></td>
