...
<body>
	...
	if ($id_pkm != "") {
		$jdl = "LAPORAN KEJADIAN IKUTAN PASCA IMUNISASI (KIPI) " .$re." ".strtoupper($this->om->bentuk_admin($id_pkm,"p")) ." ".strtoupper($this->om->identitas_general($id_pkm)->nama_pkm);
	...
	?>
	<p align="center" class="judul"><strong><?php echo $jdl.$de." KABUPATEN ".$this->om->web_me()->kabupaten ?><br> TAHUN <?php echo $tahun." BULAN ".strtoupper(getBulan($bulan)) ?></strong></p>
