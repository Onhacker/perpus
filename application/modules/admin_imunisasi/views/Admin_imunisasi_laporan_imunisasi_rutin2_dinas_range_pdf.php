		...
		<?php endforeach; ?>
			<tr>
				...
				$this->db->where("tgl_suntik BETWEEN '".tgl_simpan($awal)."' AND '".tgl_simpan($akhir)."'");
					...
					$hbp = $this->db->get("imunisasi");
				?>
				<td width="2.5%" align="center"><?php echo ($hbl->num_rows()) ?></td>
				<td width="2.5%" align="center"><?php echo ($hbp->num_rows()) ?></td>
				<td width="2.5%" align="center"><?php echo ($hbl->num_rows() + $hbp->num_rows()) ?></td>
				<!-- END OF  IPV (< 24 JAM) -->
				...
				$this->db->where("tgl_suntik BETWEEN '".tgl_simpan($awal)."' AND '".tgl_simpan($akhir)."'");
					...
					// exit();
				?>
				<td width="2.5%" align="center"><?php echo ($hbl1->num_rows()) ?></td>
				<td width="2.5%" align="center"><?php echo ($hbp2->num_rows()) ?></td>
				<td width="2.5%" align="center"><?php echo ($hbl1->num_rows() + $hbp2->num_rows()) ?></td>
				<!-- END OF  MR (1<7 HARI) -->
				...
				?>
				<td width="2.5%" align="center"><?php echo ($idl_ipv_t->num_rows()) ?></td>
				<td width="2.5%" align="center"><?php echo ($idl_opcp_t->num_rows()) ?></td>
				<td width="2.5%" align="center"><?php echo ($idl_ipv_t->num_rows() + $idl_opcp_t->num_rows()) ?></td>
				<!-- END OF  IDL -->
				...
				if (strlen($jum_bayi_si_tahun_lalu_p+$jum_bayi_si_tahun_lalu_l) > 4) {
				 ...
				 ?>
				<td width="2.5%" align="center" style="font-size: <?php echo $st ?>"><?php echo ($jum_bayi_si_tahun_lalu_l) ?></td>
				<td width="2.5%" align="center" style="font-size: <?php echo $st1 ?>"><?php echo ($jum_bayi_si_tahun_lalu_p) ?></td>
				<td width="2.5%" align="center" style="font-size: <?php echo $st2 ?>"><?php echo ($jum_bayi_si_tahun_lalu_p+$jum_bayi_si_tahun_lalu_l) ?></td>
				...
				$polio1p = $this->db->get("imunisasi");
					...
					// exit();
				?>
				<td width="2.5%" align="center"><?php echo ($polio1l->num_rows()) ?></td>
				<td width="2.5%" align="center"><?php echo ($polio1p->num_rows()) ?></td>
				<td width="2.5%" align="center"><?php echo ($polio1l->num_rows() + $polio1p->num_rows()) ?></td>
				<!-- END OF  PENTAVALEN LANJUTAN -->
				...
				$this->db->where("tgl_suntik BETWEEN '".tgl_simpan($awal)."' AND '".tgl_simpan($akhir)."'");
					...
					// exit();
				?>
				<td width="2.5%" align="center"><?php echo ($pentavaln1l->num_rows()) ?></td>
				<td width="2.5%" align="center"><?php echo ($pentabalen1p->num_rows()) ?></td>
				<td width="2.5%" align="center"><?php echo ($pentavaln1l->num_rows() + $pentabalen1p->num_rows()) ?></td>
				<!-- END OF  CAMPAK LANJUTAN -->
				...
				$polio2p = $this->db->get("imunisasi");
					...
					// exit();
				?>
				<td width="2.5%" align="center"><?php echo ($polio2l->num_rows()) ?></td>
				<td width="2.5%" align="center"><?php echo ($polio2p->num_rows()) ?></td>
				<td width="2.5%" align="center"><?php echo ($polio2l->num_rows() + $polio2p->num_rows()) ?></td>
				<!-- END OF  MR LANJUTAN -->
				<?php 
				...
				<td width="2.5%" align="center" style="font-size: <?php echo $st4 ?>"><?php echo ($jum_wus_hamil) ?></td>
				<!-- BUMIL TT1 -->
				<?php
				...
				?>
				<td width="2%" align="center"><?php echo ($tt1->num_rows()) ?></td>
				<td width="2%" align="center"><?php echo ($tt2->num_rows()) ?></td>
				<td width="2%" align="center"><?php echo ($tt3->num_rows()) ?></td>
				<td width="2%" align="center"><?php echo ($tt4->num_rows()) ?></td>
				<td width="2%" align="center"><?php echo ($tt5->num_rows()) ?></td>
				<td width="2.5%" align="center"><?php echo ($ttll->num_rows()) ?></td>
				<?php 
				...
				?>
				<td width="2%" align="center"><?php echo ($ttw1->num_rows()) ?></td>
				<td width="2%" align="center"><?php echo ($ttw2->num_rows()) ?></td>
				<td width="2%" align="center"><?php echo ($ttw3->num_rows()) ?></td>
				<td width="2%" align="center"><?php echo ($ttw4->num_rows()) ?></td>
				<td width="2%" align="center"><?php echo ($ttw5->num_rows()) ?></td>
				<td width="2%" align="center"><?php echo ($ttwll->num_rows()) ?></td>
			</tr>
	</table>
<p></p>
