...
$val = $this->db->get("im_tahun_vaksin");
// echo $val->num_rows();
?>
    
<?php if ($val->num_rows() <> 1) { ?>
     <script src="<?php echo base_url('assets/admin') ?>/libs/sweetalert2/sweetalert2.min.js"></script>
    <script type="text/javascript">
     Swal.fire({
        title: "Anda Tidak Dapat Melanjutkan",
        text: "Silahkan Lengkapi Data Demografi Tahun " +<?php echo date("Y") ?>+" Terlebih Dahulu Untuk Melanjutkan !!",
        type: "warning",
        showCancelButton: false,
        confirmButtonColor: "#6495ED",
        cancelButtonColor: "#3085d6",
        confirmButtonText: "Ya, Siapp",
        cancelButtonText: "Batal",
        allowOutsideClick: false,
    }).then((result) => {
        if (result.value) {
            window.location="<?php echo site_url()?>/admin_tahun_vaksin";
        } else {
                        ...
                        <div class="col-12" id="btnshow">
                            <div class="row ">
                                ...
                                <div class="input-group  mb-3"> 
                                    ...
                                    <input type="text" class="form-control" placeholder="Cari Nama Anak" name="nama" id="nama" readonly="">    
                                </div>
                            </div>
                        </div>
                              ...
                              <!--       <div class="col-md-3">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group mb-3">
                                           ...
                                           <small class="text-danger">Mengatur Tanggal Penyuntikan akan mengolah data umur  Anak saat divaksin berdasarkan tanggal penyuntikan. Umur Vaksin terhitung mulai tanggal lahir sampai tanggal penyuntikan</small>
                                       </div>
                                    </div> <!-- end col -->
                                     <div class="col-md-3">
                                        <div class="form-group mb-3">
    ...
    <div class="modal-dialog modal-lg  modal-dialog-scrollable" role="document">
        <div class="modal-content" style="background-color: #E4F3FD">
            ...
            <div class="modal-body">
                ...
                <a href="<?php echo site_url()."admin_anak" ?>" target ="_BLANK" class="btn btn-primary btn-xs" > Register Anak </a> 
                   <span class="help-block mt-10 ml-2"><small>Jika pencarian nama tidak ditemukan, Silahkan Register Anak terlebih dahulu.</small></span>
