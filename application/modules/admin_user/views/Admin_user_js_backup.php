        ...
        if(list_id.length == 1) { 
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#permission_publish').val(data.permission_publish);
                    ...
                    if(data.foto == ""){
                        ...
                        $('#previewImage').attr('src', '<?php echo base_url("upload/users/") ?>' + data.foto);
                        $("#hapus_gambar").show();  
                        $("#text_upload").show();
                    }
                    $('#full-width-modal').modal('show'); 
                    $('.mymodal-title').html('Edit Data <code>'+ data.nama_lengkap+'</code>'); 
                },
                error: function (jqXHR, textStatus, errorThrown) {
