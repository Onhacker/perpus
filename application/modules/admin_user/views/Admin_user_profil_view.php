    	...
    	<div class="col-lg-4 col-xl-4">
    		<div class="card-box text-center">
                <?php if ($record->tanggal_reg == "0000-00-00"){ ?>
                    ...
                    <p></p>
                    <p class="text-muted mb-2 font-13"><strong>Email :</strong> <span class="ml-2 " id= "mail_ver"><?php echo $record->email ?></span></p>
                ...
                <?php } else { ?>
                    ...
                    <div class="text-left mt-3">
                        <p class="text-muted mb-2 font-13"><strong>Hp :</strong><span class="ml-2"><?php echo $record->no_telp ?></span></p>
                        <p class="text-muted mb-2 font-13"><strong>Email :</strong> <span class="ml-2 " id= "mail"><?php echo $record->email ?></span></p>
        		...
        		<div class="tab-content">
        			<div class="tab-pane show active" id="aboutme">
                        ...
                        <?php if ($record->tanggal_reg != "0000-00-00"){ ?>
                            ...
                            <small>Reset Password akan mengirim email ke pemilik akun untuk melakukan pengaturan ulang password</small>
