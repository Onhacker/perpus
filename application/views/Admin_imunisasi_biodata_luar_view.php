...
<body>
	...
	<?php } else {?>
			<p  class="judulz"><strong>TANDA BUKTI VAKSIN LUAR WILAYAH <?php echo strtoupper($this->fm->bentuk_admin($res->id_pkm,"p"))." ".strtoupper($this->fm->identitas_general($res->id_pkm)->nama_pkm) ?></strong></p>
	<?php } ?>
