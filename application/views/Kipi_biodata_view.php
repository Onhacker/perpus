...
<body>
	...
	<hr>
		...
		<?php } else { 
			...
			<p  class="judulz"><strong>TANDA BUKTI PELAPORAN KEJADIAN IKUTAN PASCA IMUNISASI (KIPI) </strong></p>
			<?php } else { ?>
				<p  class="judulz"><strong>TANDA BUKTI PELAPORAN KEJADIAN IKUTAN PASCA IMUNISASI (KIPI)<br> LUAR WILAYAH <?php echo strtoupper($this->fm->bentuk_admin($res->id_pkm,"p"))." ". strtoupper($this->fm->identitas_general($res->id_pkm)->nama_pkm)  ?></strong></p>
			<?php } 
		} 
		?>
