<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    $('#summernote,#summernote_misi').summernote({
      toolbar: [
      ['style', ['style']],
    ...
    $.ajax({
        ...
        success: function(result) {
          ...
          if(result.success == false){
            ...
            $('#summernote_str').summernote("insertImage", result.img);
          }
    ...
    Swal.fire({
      ...
      allowOutsideClick: false,
        ...
        if (result.value) {
          ...
          $('#summernote,#summernote_misi,#summernote_str').summernote("insertImage", src);
        }
    })
  }
